...
export default {
    ...
    data() {
        return {
			init: {
                language_url: '/libs/tinymce@5.10.2/langs/zh_CN.js',  //引入语言包文件
				language: 'zh_CN',  //语言类型

                skin_url: '/libs/tinymce@5.10.2/skins/ui/oxide',  //皮肤：浅色
                skin_url: '/libs/tinymce@5.10.2/skins/ui/oxide-dark',//皮肤：暗色
				...
				content_css: '/libs/tinymce@5.10.2/skins/content/default/content.css',  //以css文件方式自定义可编辑区域的css样式，css文件需自己创建并引入
