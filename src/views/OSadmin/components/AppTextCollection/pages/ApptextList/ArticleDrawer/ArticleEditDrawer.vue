        ...
        <el-form ref="form" :model="formModel" :rules="formModelRule" label-width="80px" label-position="left">
            ...
            <template v-else>
                <el-form-item label="文章分组" prop="classifyPath">
                    <el-select v-model="formModel.classifyPath" :popper-class="storeProfilesgetter" size="small" placeholder="请选择类别">
            ...
            <el-form-item v-if="formModelParams._action === 'add'" label="文章格式" prop="textType">
                <el-select size="small" :popper-class="storeProfilesgetter" placeholder="请选择" v-model="formModel.textType">
