<template>
    <div class="BM-BW-article">
        <div class="d-flex">
            <el-cascader class="flex-item" size="small" placeholder="章节分组选择"
        ...
        <EditDrawer v-model:visible="editDrawer" :formModelParams="editDrawerParams" :bookclassTree="bookclassTree" @updateData="updateData" />
...
const { bookclassTree, getBookClassData } = BookClassDataHook();
...
async function getTableData() {
    ...
    const { data, count } = await service.Return_articlelist({
        parentId: '',
