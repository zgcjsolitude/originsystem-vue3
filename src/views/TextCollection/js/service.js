...
export default {
    ...
    Add_apptextmodel({ userId, userPassword, name, nameEn, mode, intro, classifyType, listType, contentType }, apiTag = '', ErrorMsg = true) { 
        return handlePostData(`/${apiTag}/textcollection/model/add`, { userId, userPassword, name, nameEn, mode, intro, classifyType, listType, contentType }, ErrorMsg, '增加应用文集模板');
    },
    Modify_apptextmodel({ userId, userPassword, _id, id, uuid, name, nameEn, intro, classifyType, listType, listOption, contentType }, apiTag = '', ErrorMsg = true) { 
        return handlePostData(`/${apiTag}/textcollection/model/modify`, { userId, userPassword, _id, id, uuid, name, nameEn, intro, classifyType, listType, listOption, contentType }, ErrorMsg, '修改应用文集模板信息');
    },
    ...
    // 文集文章Tree cdur
    Return_modelarticletreelist({ appUuid }, apiTag = '') {  
        return handleGetData(`/${apiTag}/textcollection/modelarticletreelist`, { appUuid }, false, '获取文集文章列表', 'only_array');
    },
    Return_modelarticletree({ _id }, apiTag = '') {  
        return handleGetData(`/${apiTag}/textcollection/modelarticletreemsg`, { _id }, true, '获取文集文章详情', 'one_object');
    },
    Add_modelarticletree({ userId, userPassword, appUuid, title, poet, parentId, parentPath, level, type, tag, textType, customText, htmlText, intro, remarks }, apiTag = '', ErrorMsg = true) { 
        return handlePostData(`/${apiTag}/textcollection/modelarticletree/add`, { userId, userPassword, appUuid, title, poet, parentId, parentPath, level, type, tag, textType, customText, htmlText, intro, remarks }, ErrorMsg, '增加文集文章信息');
    },
    Modify_modelarticletree({ userId, userPassword, _id, id, title, poet, parentId, type, tag, textType, customText, htmlText, intro, remarks }, apiTag = '', ErrorMsg = true) { 
        return handlePostData(`/${apiTag}/textcollection/modelarticletree/modify`, { userId, userPassword, _id, id, title, poet, parentId, type, tag, textType, customText, htmlText, intro, remarks }, ErrorMsg, '修改文集文章信息');
    },
    Delete_modelarticletree({ userId, userPassword, _id, id }, apiTag = '', ErrorMsg = true) { 
        return handlePostData(`/${apiTag}/textcollection/modelarticletree/delete`, { userId, userPassword, _id, id }, ErrorMsg, '删除文集文章信息') 
    },
}