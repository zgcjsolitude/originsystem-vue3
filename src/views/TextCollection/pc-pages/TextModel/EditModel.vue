        ...
        <el-dialog title="应用文集模板" :model-value="visible" @open="openEvent" @close="closeEvent">
            <el-form ref="form" :model="formModel" :rules="formModelRule" label-width="150px" label-position="right">
                ...
                <el-form-item label="模板英文名称" prop="nameEn">
                    <el-input v-model="formModel.nameEn"></el-input>
                </el-form-item>

                <el-form-item v-if="formModelParams._action === 'add'" label="模板文集结构" prop="mode">
                    <el-select :popper-class="storeProfilesgetter" placeholder="请选择" v-model="formModel.mode" @change="formModelModeChange">
                        <el-option label="组-文集模式" value="Classify-Article"></el-option>
                        <el-option label="树-文章模式" value="Tree-Article"></el-option>
                    </el-select>
                </el-form-item>
                ...
                <template v-if="formModel.mode === 'Classify-Article'">                
                    <div>
                        组-文集模式 配置
                    </div>

                    <el-form-item label="分组展示形式" prop="classifyType">
                        <el-select :popper-class="storeProfilesgetter" placeholder="请选择" v-model="formModel.classifyType">
                    ...
                    <el-form-item label="文集展示形式" prop="listType">
                        <el-select :popper-class="storeProfilesgetter" placeholder="请选择" v-model="formModel.listType">
                        <el-option label="表格" value="Table"></el-option>
                        </el-select>
                    </el-form-item>

                    <el-form-item label="文本默认格式" prop="contentType">
                        <el-select :popper-class="storeProfilesgetter" placeholder="请选择" v-model="formModel.contentType">
...
function clearFormModel() {
    formModel.name = '';
    formModel.nameEn = '';
    formModel.mode = 'Classify-Article';
    formModel.intro = '';
...
function formModelModeChange() {
    if (formModel.mode === 'Tree-Article') {
        formModel.contentType = 'richText';
    }
}
